...
class Settings(BaseSettings):
    ...
    # Control de acceso seguro por defecto: se exige JWT salvo que se desactive
    # de forma EXPLÍCITA (solo para entornos de prueba locales). Nunca dejarlo
    # en true en producción.
    auth_deshabilitado: bool = False
    port: int = 8000
    log_level: str = "INFO"
    ...
    # Por defecto sin orígenes (deny-by-default). Configurar BIOGUARD_CORS_ORIGINS
    # con la lista explícita de orígenes permitidos en producción.
